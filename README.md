...
- [prep.txt](./prep.txt) given to Gemini based on all the conversations.
- [prompt.txt](./prompt.txt) and [hints.txt](./hints.txt) is generated by Gemini and provided to IBM Bob.
- [summary.txt](./summary.txt) is the changelog of sorts being updated by IBM Bob during implementation sessions.
